# =============================================================================
# DayCent BAR3 Spring Barley Calibration — RM Level
...
config <- list(
  ...
  template_dir   = "/home/prs352/Daycent/Crop_Optimization/Models/Barley/Copy_Folder",
  sites_dir      = "/home/prs352/Daycent/Crop_Optimization/Models/Barley/qrts",
  results_dir    = "/home/prs352/Daycent/Crop_Optimization/Models/Barley/results",
  obs_data_path  = "/home/prs352/Daycent/Crop_Optimization/Models/input_data/barley_c_gmsq.csv",
...
write_crop100 <- function(params, template_path, output_path, crop_name = "BAR3") {
...
lower <- c(  1.0,   10.0,  20.0,  0.20,    6.0,     1.5 )
upper <- c(  5.0,   20.0,  32.0,  0.50,   30.0,     4.5 )
...
# Seed initial population around best solution from prior run (57 generations)
# PRDX1=2.754, PPDF1=13.035, PPDF2=28.098, WSCOEF1=0.203, WSCOEF2=6.330, CLAYPG=4
best_known <- c(2.754, 13.035, 28.098, 0.203, 6.330, 4.0)
noise_frac  <- 0.40  # ±40% of parameter range — wider spread prevents premature convergence
ranges      <- upper - lower
...
# Force best known as first member
...
p <- ggplot(rm_final, aes(x = obs_mean, y = sim_mean)) +
  ...
  labs(
    title    = "DayCent RM-Level Spring Barley Calibration: Simulated vs Observed",
