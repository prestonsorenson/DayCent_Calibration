# =============================================================================
# DayCent DURUM Durum Wheat Calibration — RM Level
...
config <- list(
  ...
  template_dir   = "/home/prs352/Daycent/Crop_Optimization/Models/Durum/Copy_Folder",
  sites_dir      = "/home/prs352/Daycent/Crop_Optimization/Models/Durum/qrts",
  results_dir    = "/home/prs352/Daycent/Crop_Optimization/Models/Durum/results",
  obs_data_path  = "/home/prs352/Daycent/Crop_Optimization/Models/input_data/durum_c_gmsq.csv",
...
write_crop100 <- function(params, template_path, output_path, crop_name = "SW0") {
...
upper <- c(  5.0,   25.0,  32.0,  0.50,   30.0,     4.5 )
...
# Seed initial population around best solution from prior run (125 generations)
# PRDX1=3.105, PPDF1=20.000, PPDF2=28.853, WSCOEF1=0.214, WSCOEF2=6.001, CLAYPG=4
best_known <- c(3.105, 20.000, 28.853, 0.214, 6.001, 4.0)
noise_frac  <- 0.10
ranges      <- upper - lower
...
p <- ggplot(rm_final, aes(x = obs_mean, y = sim_mean)) +
  ...
  labs(
    title    = "DayCent RM-Level Durum Wheat Calibration: Simulated vs Observed",
