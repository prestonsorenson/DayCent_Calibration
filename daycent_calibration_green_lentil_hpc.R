# =============================================================================
# DayCent LENT Green Lentil Calibration — RM Level
...
config <- list(
  ...
  template_dir   = "/home/prs352/Daycent/Crop_Optimization/Models/Green_Lentil/Copy_Folder",
  sites_dir      = "/home/prs352/Daycent/Crop_Optimization/Models/Green_Lentil/qrts",
  results_dir    = "/home/prs352/Daycent/Crop_Optimization/Models/Green_Lentil/results",
  obs_data_path  = "/home/prs352/Daycent/Crop_Optimization/Models/input_data/lentilG_c_gmsq.csv",
...
upper <- c(  5.0,   20.0,  36.0,  0.50,   30.0,     4.5 )
...
# Seed initial population around best solution from prior run (122 generations)
# PRDX1=1.983, PPDF1=15.158, PPDF2=31.930, WSCOEF1=0.200, WSCOEF2=6.014, CLAYPG=2
best_known <- c(1.983, 15.158, 31.930, 0.200, 6.014, 2.0)
noise_frac  <- 0.10
ranges      <- upper - lower
...
p <- ggplot(rm_final, aes(x = obs_mean, y = sim_mean)) +
  ...
  labs(
    title    = "DayCent RM-Level Green Lentil Calibration: Simulated vs Observed",
