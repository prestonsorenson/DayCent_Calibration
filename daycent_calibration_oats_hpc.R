# =============================================================================
# DayCent OAT1 Oats Calibration — RM Level
...
config <- list(
  ...
  template_dir   = "/home/prs352/Daycent/Crop_Optimization/Models/Oats/Copy_Folder",
  sites_dir      = "/home/prs352/Daycent/Crop_Optimization/Models/Oats/qrts",
  results_dir    = "/home/prs352/Daycent/Crop_Optimization/Models/Oats/results",
  obs_data_path  = "/home/prs352/Daycent/Crop_Optimization/Models/input_data/oats_c_gmsq.csv",
...
write_crop100 <- function(params, template_path, output_path, crop_name = "OAT1") {
...
# Seed initial population around best solution from prior run (126 generations)
# PRDX1=3.284, PPDF1=13.001, PPDF2=31.984, WSCOEF1=0.260, WSCOEF2=13.926, CLAYPG=4
best_known <- c(3.284, 13.001, 31.984, 0.260, 13.926, 4.0)
noise_frac  <- 0.10
ranges      <- upper - lower
...
p <- ggplot(rm_final, aes(x = obs_mean, y = sim_mean)) +
  ...
  labs(
    title    = "DayCent RM-Level Oats Calibration: Simulated vs Observed",
