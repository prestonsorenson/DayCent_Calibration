# =============================================================================
# DayCent LENT Red Lentil Calibration — RM Level
...
config <- list(
  ...
  template_dir   = "/home/prs352/Daycent/Crop_Optimization/Models/Red_Lentil/Copy_Folder",
  sites_dir      = "/home/prs352/Daycent/Crop_Optimization/Models/Red_Lentil/qrts",
  results_dir    = "/home/prs352/Daycent/Crop_Optimization/Models/Red_Lentil/results",
  obs_data_path  = "/home/prs352/Daycent/Crop_Optimization/Models/input_data/lentilR_c_gmsq.csv",
...
write_crop100 <- function(params, template_path, output_path, crop_name = "LENT") {
...
upper <- c(  5.0,   25.0,  36.0,  0.50,   30.0,     4.5 )
...
# Seed initial population around best solution from prior run (114 generations)
# PRDX1=2.716, PPDF1=19.994, PPDF2=30.789, WSCOEF1=0.200, WSCOEF2=6.006, CLAYPG=4
best_known <- c(2.716, 19.994, 30.789, 0.200, 6.006, 4.0)
noise_frac  <- 0.10
ranges      <- upper - lower
...
p <- ggplot(rm_final, aes(x = obs_mean, y = sim_mean)) +
  ...
  labs(
    title    = "DayCent RM-Level Red Lentil Calibration: Simulated vs Observed",
